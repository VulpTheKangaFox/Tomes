...
public class SpectralSteedRenderer<T extends SpectralSteedEntity> extends MobRenderer<T, HorseModel<T>> {
    ...
    private static final ResourceLocation SPECTRAL_STEED_TEXTURE = TomesRegistry.location("textures/entity/spectral_steed.png");
    private static final ResourceLocation SPECTRAL_STEED_FADE_TEXTURE = TomesRegistry.location("textures/entity/spectral_steed_fade.png");

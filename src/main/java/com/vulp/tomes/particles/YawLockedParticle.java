...
public abstract class YawLockedParticle extends SpriteTexturedParticle {

    private float pitch;
    private float yaw;
    private final Quaternion rotation = new Quaternion(0.0F, 0.0F, 0.0F, 1.0F);

    protected YawLockedParticle(ClientWorld world, double x, double y, double z, double velX, double velY, double velZ) {
        super(world, x, y, z);
    }

    protected YawLockedParticle(ClientWorld world, double x, double y, double z) {
